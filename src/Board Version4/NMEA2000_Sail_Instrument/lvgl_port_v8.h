...
#define LVGL_PORT_TICK_PERIOD_MS                (2) // The period of the LVGL tick task, in milliseconds fvt was 2
 ...
 *
 */
//#define LVGL_PORT_BUFFER_MALLOC_CAPS            (MALLOC_CAP_INTERNAL | MALLOC_CAP_DMA)  // Allocate LVGL buffer in SRAM //////////////////////////// fvt was | 8BIT) instead of | MALLOC_CAP_DMA)
#define LVGL_PORT_BUFFER_MALLOC_CAPS            (MALLOC_CAP_SPIRAM)      // Allocate LVGL buffer in PSRAM
#define LVGL_PORT_BUFFER_SIZE                   (LVGL_PORT_DISP_WIDTH * 20)   // fvt was 20
 ...
 *
 */
#define LVGL_PORT_TASK_MAX_DELAY_MS             (5)       // The maximum delay of the LVGL timer task, in milliseconds was 3
#define LVGL_PORT_TASK_MIN_DELAY_MS             (5)         // The minimum delay of the LVGL timer task, in milliseconds was 3
#define LVGL_PORT_TASK_STACK_SIZE               (10 * 1024)  // The stack size of the LVGL timer task, in bytes  /////////////////////////////////////////fvt was 6
#define LVGL_PORT_TASK_PRIORITY                 (10)         // The priority of the LVGL timer task  /////////////////////////////////////////////////////fvt was 2
#define LVGL_PORT_TASK_CORE                     (0)         // FVT default value is (ARDUINO_RUNNING_CORE) 
 ...
 *
 */
#define LVGL_PORT_AVOID_TEARING_MODE            (2)   // fvt stable value is 2
 ...
 *
 */
#define LVGL_PORT_RGB_BOUNCE_BUFFER_SIZE        (LVGL_PORT_DISP_WIDTH * 15)  //////////////////////////////////// fvt was 10
/**
...
// Set the buffer number and refresh mode according to the different modes
    ...
    #define LVGL_PORT_FULL_REFRESH              (1)   // fvt was 1
